 ...
 * Size: 100 px
 * Bpp: 8
 * Opts: --bpp 8 --size 100 --font D:\cs\jos\Documents\_Brouwerij\Automatisering\PlatformIO\BrewScale-LVGL\squareline\assets\digital-7 (mono italic).ttf -o D:\cs\jos\Documents\_Brouwerij\Automatisering\PlatformIO\BrewScale-LVGL\squareline\assets\ui_font_weightSmallFont.c --format lvgl --symbols +-.0123456789hilo --no-compress --no-prefilter
 ******************************************************************************/

#include "../ui.h"

#ifndef UI_FONT_WEIGHTSMALLFONT
#define UI_FONT_WEIGHTSMALLFONT 1
#endif

#if UI_FONT_WEIGHTSMALLFONT
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t ui_font_weightSmallFont = {
#else
lv_font_t ui_font_weightSmallFont = {
#endif
...
#endif /*#if UI_FONT_WEIGHTSMALLFONT*/
