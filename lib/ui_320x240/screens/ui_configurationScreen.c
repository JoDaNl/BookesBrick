...
void ui_configurationScreen_screen_init(void)
{
    ...
    ui_setPanel1 = lv_obj_create(ui_statusContainer1);
    lv_obj_set_width(ui_setPanel1, 40);
    lv_obj_set_height(ui_setPanel1, 21);
    lv_obj_set_x(ui_setPanel1, 0);
    lv_obj_set_y(ui_setPanel1, 30);
    lv_obj_set_align(ui_setPanel1, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_setPanel1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_testLabel1 = lv_label_create(ui_setPanel1);
    lv_obj_set_width(ui_testLabel1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_testLabel1, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_testLabel1, -1);
    lv_obj_set_y(ui_testLabel1, 0);
    lv_obj_set_align(ui_testLabel1, LV_ALIGN_CENTER);
    lv_label_set_text(ui_testLabel1, "O");

    ui_setLabel1 = lv_label_create(ui_setPanel1);
    lv_obj_set_width(ui_setLabel1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_setLabel1, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_setLabel1, 0);
    lv_obj_set_y(ui_setLabel1, 24);
    lv_obj_set_align(ui_setLabel1, LV_ALIGN_CENTER);
    lv_label_set_text(ui_setLabel1, "SET");

    ui_modePanel1 = lv_obj_create(ui_statusContainer1);
    lv_obj_set_width(ui_modePanel1, 54);
    lv_obj_set_height(ui_modePanel1, 21);
    lv_obj_set_x(ui_modePanel1, 51);
    lv_obj_set_y(ui_modePanel1, 30);
    lv_obj_set_align(ui_modePanel1, LV_ALIGN_CENTER);
    lv_obj_clear_flag(ui_modePanel1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_modeLabel1 = lv_label_create(ui_modePanel1);
    lv_obj_set_width(ui_modeLabel1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_modeLabel1, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_modeLabel1, LV_ALIGN_CENTER);
    lv_label_set_text(ui_modeLabel1, "MODE");
    ...
    ui_OKButton1 = lv_btn_create(ui_confirmPanel1);
    lv_obj_set_width(ui_OKButton1, 100);
    lv_obj_set_height(ui_OKButton1, 50);
    lv_obj_set_x(ui_OKButton1, -58);
    lv_obj_set_y(ui_OKButton1, 15);
    ...
    lv_obj_set_style_bg_color(ui_OKButton1, lv_color_hex(0x14FF00), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_OKButton1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_OKLabel1 = lv_label_create(ui_OKButton1);
    lv_obj_set_align(ui_OKLabel1, LV_ALIGN_CENTER);
    lv_label_set_text(ui_OKLabel1, "OK");
    ...
    lv_obj_add_event_cb(ui_OKButton1, ui_event_OKButton1, LV_EVENT_ALL, NULL);
