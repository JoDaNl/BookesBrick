...
lv_obj_t * ui_SGPanel2;
lv_obj_t * ui_hydroLabel1;
lv_obj_t * ui_hydroLabelDot2;
lv_obj_t * ui_hydroLabel2;
lv_obj_t * ui_unitLabel1;
lv_obj_t * ui_setpointPanel1;
lv_obj_t * ui_setPointLabel1;
lv_obj_t * ui_weightLabelDot1;
lv_obj_t * ui_setPointSmallLabel1;
lv_obj_t * ui_SETLabel1;
lv_obj_t * ui_coolHeatPanel1;
lv_obj_t * ui_offLabel1;
lv_obj_t * ui_coolLabel1;
lv_obj_t * ui_heatLabel1;
lv_obj_t * ui_coolBar1;
lv_obj_t * ui_heatBar1;
