...
void ui_configurationScreen_screen_init(void)
{
    ...
    lv_obj_set_x(ui_TitleContainer1, 3);
    lv_obj_set_y(ui_TitleContainer1, -149);
    ...
    lv_obj_set_x(ui_statusContainer1, -79);
    lv_obj_set_y(ui_statusContainer1, 147);
    ...
    ui_Label1 = lv_label_create(ui_statusContainer1);
    lv_obj_set_width(ui_Label1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_Label1, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_x(ui_Label1, -123);
    lv_obj_set_y(ui_Label1, -1);
    lv_obj_set_align(ui_Label1, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Label1, "Uptime:");
